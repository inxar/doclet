...
public class HtmlStandardWriter extends HtmlDocWriter {
     ...
     */
    protected void navLinks2(boolean header) {
        println("");
    ...
    protected void navLinks(boolean header) {
        ...
        if (!Standard.configuration().nonavbar) {
            ...
            //trAlignVAlign("center", "top");
	    print("<TR ALIGN=\"center\" VALIGN=\"\" WIDTH=\"100%\">");
    ...
    public void tableSpecialStart()
    {
	print("\n<TABLE BORDER=\"0\" CELLPADDING=\"0\" " + 
	      "CELLSPACING=\"0\" WIDTH=\"100%\" CLASS=\"TableBorderColor\"><TR><TD>");
    }
    // AAAAAA

    public void tableSpecialEnd()
    {
	println("</TD></TR></TABLE>");
    }
   ...
   /**
    ...
    public void hrSpecial() {
	String pixel = replaceDocRootDir("{@docroot}") + "../images/null.png";
        println("<table bgcolor=\"black\" width=\"100%\"><tr height=\"0\"><td>" + 
		"<img src=\"" + pixel + "\"></td></tr></table>");
    }

    public void hrNoShade() {
        println("<hr noshade size=\"0\">");
    }
