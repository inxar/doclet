...
public abstract class AbstractSubWriter {
    ...
    protected void printHeadSpecial(MemberDoc member) {
        writer.h2();
        writer.print("<code>" + member.name() +"</code>");
        writer.h2End();
    }
    ...
    public void printSummaryHeader(String resource, ClassDoc cd) {
        writer.printSummaryHeader(this, resource, cd);
    }
    ...
    public void printMembers2() {
		...
		writer.trEnd();
            ...
            printFooter2(classdoc);
        }
    }

    protected void printHeader2(ClassDoc cd) {
	writer.tableSpecialStart();
        writer.tableIndexDetail();
        writer.tableHeaderStart("#CCCCFF", 1);
    ...
    protected void printFooter2(ClassDoc cd)
    {
	writer.tableEnd();
	writer.tableSpecialEnd();
	writer.p();
    }
